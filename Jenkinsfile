pipeline {
    ...
    parameters {
         string(name: 'tomcat_dev', defaultValue: '3.90.241.35', description: 'Staging Server')
         string(name: 'tomcat_prod', defaultValue: '35.175.192.150', description: 'Production Server')
    }
